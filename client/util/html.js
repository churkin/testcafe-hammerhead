...
export const INIT_SCRIPT_FOR_IFRAME_TEMPLATE =
    '<script class="' + SharedConst.SHADOW_UI_SCRIPT_CLASSNAME + '" type="text/javascript">' +
...
export function cleanUpHtml (html, parentTag) {
    ...
    return processHtmlInternal(html, parentTag, function (container) {
        ...
        DOM.find(container, '[class*="' + SharedConst.SHADOW_UI_CLASSNAME_POSTFIX + '"]', function (el) {
            if (el.parentNode) {
        ...
        DOM.find(container, '[' + SharedConst.HOVER_PSEUDO_CLASS_ATTR + ']', function (el) {
