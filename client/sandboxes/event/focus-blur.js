...
const INTERNAL_FOCUS_FLAG = SharedConst.PROPERTY_PREFIX + 'iff';
const INTERNAL_BLUR_FLAG  = SharedConst.PROPERTY_PREFIX + 'ibf';
...
function onMouseOverHandler (e) {
        ...
        if (lastHoveredElement) {
            ...
            while (el && el.tagName) {
                ...
                if (el.contains && !el.contains(newHoveredElement)) {
                    NativeMethods.removeAttribute.call(el, SharedConst.HOVER_PSEUDO_CLASS_ATTR);
                    el = el.parentNode;
                }
                else
                    break;
            ...
            if (jointParent)
                NativeMethods.removeAttribute.call(jointParent, SharedConst.HOVER_PSEUDO_CLASS_ATTR);
        }
    ...
    var setHoverMarker = function (newHoveredElement, jointParent) {
        if (jointParent)
            NativeMethods.setAttribute.call(jointParent, SharedConst.HOVER_PSEUDO_CLASS_ATTR, '');
        ...
        while (newHoveredElement && newHoveredElement.tagName) {
            ...
            if (newHoveredElement !== jointParent) {
                NativeMethods.setAttribute.call(newHoveredElement, SharedConst.HOVER_PSEUDO_CLASS_ATTR, '');
