...
const UPLOAD_IFRAME_FOR_IE9_ID = 'uploadIFrameForIE9' + SharedConst.SHADOW_UI_CLASSNAME_POSTFIX;
...
function getUploadIFrameForIE9 () {
    ...
    if (!uploadIFrame) {
        ...
        NativeMethods.querySelector.call(document, '#root' +
                                                   SharedConst.SHADOW_UI_CLASSNAME_POSTFIX).appendChild(uploadIFrame);
    }
