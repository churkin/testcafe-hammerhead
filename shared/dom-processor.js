...
const IS_STYLESHEET_PROCESSED_REG_EX = new RegExp('^\\s*' + SharedConst.IS_STYLESHEET_PROCESSED_COMMENT
        .replace(/\/|\*/g, '\\$&'));

const OVERRIDE_DOM_METH_SCRIPT = 'window["' + SharedConst.DOM_SANDBOX_OVERRIDE_DOM_METHOD_NAME + '"]';
